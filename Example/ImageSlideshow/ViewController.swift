...
class ViewController: UIViewController {
    ...
    let localSource = [ImageSource(imageString: "img1", caption: "Caption 1")!, ImageSource(imageString: "img2")!, ImageSource(imageString: "img3", caption: "Caption 3")!, ImageSource(imageString: "img4")!]
